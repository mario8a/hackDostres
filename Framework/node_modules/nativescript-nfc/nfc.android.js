...
var Nfc = /** @class */ (function () {
    function Nfc() {
        ...
        // start nfc
        var nfcAdapter = android.nfc.NfcAdapter.getDefaultAdapter(activity);
        ...
        if (Nfc.firstInstance) {
            ...
            application.android.on(application.AndroidApplication.activityNewIntentEvent, function (args) {
                exports.nfcIntentHandler.savedIntent = intent;
                exports.nfcIntentHandler.parseMessage();
            });
            // on startup, we want to make sure the adapter is listening
            var startupNfcAdapter = android.nfc.NfcAdapter.getDefaultAdapter(activity);
    ...
    Nfc.prototype.eraseTag = function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (intent === null || exports.nfcIntentHandler.savedIntent === null) {
                reject("Can't erase tag; didn't receive an intent");
                return;
            }
            var tag = exports.nfcIntentHandler.savedIntent.getParcelableExtra(android.nfc.NfcAdapter.EXTRA_TAG);
            ...
            var errorMessage = _this.writeNdefMessage(ndefMessage, tag);
